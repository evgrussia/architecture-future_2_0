...
Документ продолжает целевую архитектуру из [Task1](../Task1/target-architecture-and-prioritization.md) и состоит из трёх частей:
...
![DFD уровень 0 — контекст](./dfd-level0-context.png)
...
![DFD уровень 1 — интеграция нового финтех-сервиса](./dfd-level1-new-fintech.png)
...
![DFD уровень 1 — ИИ анализирует медданные](./dfd-level1-ai-medical.png)
...
- Целевая архитектура и приоритизация проблем — [Task1](../Task1/target-architecture-and-prioritization.md).
