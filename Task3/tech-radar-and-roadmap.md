...
Документ опирается на целевую архитектуру [Task1](../Task1/target-architecture-and-prioritization.md) и доменную модель [Task2](../Task2/domains-and-data-flows.md) и состоит из трёх частей:
...
![Роадмап трансформации (Gantt)](./roadmap-gantt.png)
...
- Целевая архитектура и приоритизация — [Task1](../Task1/target-architecture-and-prioritization.md).
- Домены и потоки данных (DFD) — [Task2](../Task2/domains-and-data-flows.md).
